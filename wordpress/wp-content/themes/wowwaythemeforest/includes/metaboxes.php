...
$meta_boxes = array(
	array(
		...
		'fields' => array(
			...
			array(
				'name' => __('4. Choose a height', 'wowway'),
				'desc' => __('<strong>This is important!</strong> If you are using a slider for this blog post, please put the height(px) of the images from the slider in here. All images need to have same size, so please make sure that you resize them before uploading them. Resize all images to 650 x <strong>custom_height</strong>, then input that <strong>custom_height</strong> in here.', 'wowway'),
				'id' => 'rb_post_height',
				'type' => 'text'
			)
		)
	...
	array(
		...
		'fields' => array(
			...
			array(
				'name' => __('3. Choose a height', 'wowway'),
				'desc' => __('<strong>This is important!</strong> If you are using a slider for this blog post, please put the height(px) of the images from the slider in here. All images need to have same size, so please make sure that you resize them before uploading them. Resize all images to 650 x <strong>custom_height</strong>, then input that <strong>custom_height</strong> in here.', 'wowway'),
				'id' => 'rb_post_height',
				'type' => 'text'
			)
