...
class FT_OP_Admin {
	...
	static function menu_settings()
	{
		$menu = array(
				...
				'page_title'  => __('Опции темы', 'optionsframework'),
				'menu_title'  => __('Опции темы', 'optionsframework'),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Сохранить опции', 'ft_op' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'По умолчанию', 'ft_op' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Нажмите ОК чтобы вернуть по умолчанию!', 'ft_op' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input )
	{
		...
		if ( isset( $_POST['reset'] ) ) {
				add_settings_error( 'ft-op', 'restore_defaults', __( 'Настройки по умолчанию восстановлены.', 'ft_op' ), 'updated fade' );
	...
	function save_options_notice() {
		if (!get_settings_errors())
				add_settings_error( 'ft-op', 'save_options', __( 'Опции сохранены.', 'ft_op' ), 'updated fade' );
	}
