    ...
    */
    ...
    function register_post_type() {
        ...
        $labels = array(
            ...
            'all_items' => __($plural),
            'add_new' => _('Добавить'),
            'add_new_item' => __('Добавить ' . $singular),
            'edit_item' => __('Редактировать ' . $singular),
            'new_item' => __('Новое ' . $singular),
            'view_item' => __('Просмотр ' . $singular),
            'search_items' => __('Поиск ' . $plural),
            'not_found' =>  __('На ' . $plural . ' found'),
            'not_found_in_trash' => __('На ' . $plural . ' found in Trash'),
    ...
    */
    ...
    function register_taxonomy($taxonomy_names, $options = array()) {
        ...
        $labels = array(
            ...
            'menu_name' => __($plural),
            'all_items' => __('Все ' . $plural),
            'edit_item' => __('Редактировать ' . $singular),
            'view_item' => __('Просмотр ' . $singular),
            'update_item' => __('Обновить ' . $singular),
            'add_new_item' => __('Добавить ' . $singular),
            'new_item_name' => __('Новое ' . $singular . ' Name'),
            'parent_item' => __('Parent ' . $plural),
            'parent_item_colon' => __('Parent ' . $plural .':'),
            'search_items' =>  __('Поиск ' . $plural),
            'popular_items' => __('Популярное ' . $plural),
            'separate_items_with_commas' => __('Seperate ' . $plural . ' with commas'),
            'add_or_remove_items' => __('Добавить или удалить ' . $plural),
            'choose_from_most_used' => __('Выберите из наиболее часто используемых ' . $plural),
