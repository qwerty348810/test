                ...
                <div class="biz0ne-products-services-description">
                                                    <?php 
                                                        if( of_get_option('left_section_text') ){
                                                            ...
                                                            _e('You can change this text in description box of left section block in Biz one tab of theme options page.',  'BizFlare');
                                                        }
                                                    ?>        
                ...
                <div class="biz0ne-products-services-description">
                                                    <?php 
                                                        if( of_get_option('center_section_text') ){
                                                            ...
                                                            _e('You can change this text in description box of center section block in Biz one tab of theme options page.',  'BizFlare');
                                                        }
                                                    ?>       
                </div><!-- .biz0ne-products-services-description -->                
                ...
                <div class="biz0ne-products-services-description">
                                                    <?php 
                                                        if( of_get_option('right_section_text') ){
                                                            ...
                                                            _e('You can change this text in description box of right section block in Biz one tab of theme options page.',  'BizFlare');
                                                        }
                                                    ?>        
                </div><!-- .biz0ne-products-services-description -->                
                ...
                <p>
                    <?php 
                         if( of_get_option('quote_section_text') ){
                              ...
                              _e('You can change this text in quote box of quote section block in Biz one tab of theme options page. You can change this text in quote box of quote section block in Biz one tab of theme options page.',  'BizFlare');
                         }
                    ?>
                </p> 
