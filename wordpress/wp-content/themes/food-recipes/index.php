          ...
          <div class="article">
           <div class="foodrecipes-post-box">
            ...
            <div class="foodrecipes-box-name">
              ...
              <div class="foodrecipes-hr"> Написал: <span class="foodrecipes-postby-color"><a href="<?php echo get_author_posts_url(get_the_author_meta( 'ID' )); ?>"> <?php echo get_the_author(); ?></a></span><?php if ( get_comments_number() > 0 ) : ?> Комментарии:<span class="foodrecipes-postby-color"><?php echo get_comments_number(); ?></span><?php endif; ?> </div>
            </div>
          </div>
          </div>
        </div>
